 ...
 */
final class Version20231025075045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE index_pole (id INT AUTO_INCREMENT NOT NULL, pole_id INT DEFAULT NULL, index_nom VARCHAR(255) NOT NULL, url_index VARCHAR(255) NOT NULL, INDEX IDX_56E09AB2419C3385 (pole_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
